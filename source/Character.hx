...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'space':
				// GIRLFRIEND CODE
				frames = Paths.getSparrowAtlas('characters/EmptySpace', 'shared');
			...
			case 'gf-pixel':
				...
				case 'dave-player':
					// DAVE SHITE ANIMATION LOADING CODE
					frames = Paths.getSparrowAtlas('characters/Dave', 'shared');
				    ...
				    animation.addByPrefix('singLEFTmiss', 'Dave MissLeft', 24, false);
				    animation.addByPrefix('singDOWNmiss', 'Dave MissDown', 24, false);
				    animation.addByPrefix('singRIGHTmiss', 'Dave MissRight', 24, false);
			    	animation.addByPrefix('singUPmiss', 'Dave MissUp', 24, false);
					animation.addByPrefix('firstDeath', "Dave FirstDeath", 24, false);
	    			animation.addByPrefix('deathConfirm', "Dave DeathConfirm", 24, false);
			...
			case 'doge-recursed':
				playAnim('idle');
				frames = Paths.getSparrowAtlas('doge/doge_recursed', 'shared');
				animation.addByPrefix('idle', 'Doge0', 24, false);
				animation.addByPrefix('singUP', 'Doge note up', 24, false);
				animation.addByPrefix('singRIGHT', 'Doge note right', 24, false);
				animation.addByPrefix('singDOWN', 'Doge note down', 24, false);
			...
			case 'bambi-2.5':
				...
				playAnim('idle');
			case 'corn':
				frames = Paths.getSparrowAtlas('characters/Corn', 'shared');
				animation.addByPrefix('idle', 'Corn Idle', 24, false);
				animation.addByPrefix('singLEFT', 'Corn Left', 24, false);
		        animation.addByPrefix('singDOWN', 'Corn Down', 24, false);
	    	    animation.addByPrefix('singRIGHT', 'Corn Right', 24, false);
		    	animation.addByPrefix('singUP', 'Corn Up', 24, false);
				
				barColor = FlxColor.fromRGB(115, 135, 155);
